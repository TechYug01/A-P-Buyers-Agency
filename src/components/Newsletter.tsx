      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center px-2 sm:px-4"
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <p className="font-semibold flex items-center gap-2 text-foreground">
                        ...
                        Join our WhatsApp group to get real-time access to
                        exclusive listings, deal breakdowns, and early alerts
